...
def test_includeme():
    ...
    assert config.add_route.mock_calls == [
        ...
        call('admin_groups_delete', '/admin/groups/delete/{pubid}'),
        ...
        call('admin_oauthclients_edit', '/admin/oauthclients/{id}', factory='h.traversal.AuthClientRoot', traverse='/{id}'),
        ...
        call('annotation', '/a/{id}', factory='h.traversal:AnnotationRoot', traverse='/{id}'),
        call('stream', '/stream'),
        ...
        call('organization_logo', '/organizations/{pubid}/logo',
             factory='h.traversal.OrganizationLogoRoot', traverse='/{pubid}'),
        call('api.groups', '/api/groups'),
        call('group_create', '/groups/new'),
        call('group_edit', '/groups/{pubid}/edit', factory='h.traversal.GroupRoot', traverse='/{pubid}'),
        call('group_read', '/groups/{pubid}/{slug:[^/]*}', factory='h.traversal.GroupRoot', traverse='/{pubid}'),
        call('group_read_noslug', '/groups/{pubid}', factory='h.traversal.GroupRoot', traverse='/{pubid}'),
        call('help', '/docs/help'),
